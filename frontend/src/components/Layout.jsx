...
const NAV = [
  ...
  { to:"/udhar",     label:"Udhar Khata", icon:<><path d="M14 2H6a2 2 0 00-2 2v16a2 2 0 002 2h12a2 2 0 002-2V8z"/><polyline points="14 2 14 8 20 8"/><line x1="16" y1="13" x2="8" y2="13"/><line x1="16" y1="17" x2="8" y2="17"/></> },
  ...
  { to:"/wastage",   label:"Wastage",     icon:<><polyline points="3 6 5 6 21 6"/><path d="M19 6l-1 14a2 2 0 01-2 2H8a2 2 0 01-2-2L5 6"/><path d="M10 11v6"/><path d="M14 11v6"/><path d="M9 6V4a1 1 0 011-1h4a1 1 0 011 1v2"/></> },
  { to:"/demand",    label:"Demand Intel", icon:<><path d="M22 12h-4l-3 9L9 3l-3 9H2"/></> },
